...
const path = 'C:/Users/sky/.gemini/antigravity/scratch/arthouse-clone/projects.html';
let content = fs.readFileSync(path, 'utf8');

const css1 = `<style id="blue-black-theme-overrides">
    :root {
        --bg-1800: #f4f1ea;
        --text-1800: #2c2a25;
        --accent-1800: #8c2a2a;
...
content = content.replace(/<style id="blue-black-theme-overrides">[\s\S]*?<\/style>/, css1);

const css2 = `<style id="projects-page-styles">
...
content = content.replace(/<style id="projects-page-styles">[\s\S]*?<\/style>/, css2);
